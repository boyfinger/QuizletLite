...
public partial class QuizletLiteContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<User>().HasData(
            new User { Id = 1, RoleId = 1, Email = "admin@email.com", Username = "admin", Password = "123" },
            new User { Id = 2, RoleId = 2, Email = "user1@email.com", Username = "user1", Password = "123" },
            new User { Id = 3, RoleId = 2, Email = "user2@email.com", Username = "user2", Password = "123" }
        );
